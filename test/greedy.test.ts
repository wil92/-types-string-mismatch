import Greedy = require("../greedy");
import Operation = require("../utils/operation");

const greedyInstanceWithoutOptions = new Greedy();
const greedyInstanceWithOptions = new Greedy({ignoreCase: true, ignoreSpaces: true, precision: 5});
